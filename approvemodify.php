  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Approve Modification Request</h1>
          </div>
           <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-warning">
            ...
            <div class="card-body">
            <form action="approvemodifyprocess.php" method="POST">
              ...
              <h3 class="card-title"><b>Are you sure to approve this modification?</b></h3><br><br>
