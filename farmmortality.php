          ...
          <div class="col-sm-6">
            <form class="form-inline ml-3" method="POST" action="searchprocess.php">
              <div class="input-group input-group-sm">
                <h1>Mortality Farm List</h1>&nbsp&nbsp&nbsp&nbsp&nbsp
          ...
          <div class="col-sm-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Mortality List</h3>
                    ...
                    while($rowa = mysqli_fetch_array($resulta))
                      {
                        ...
                        echo "<td>";
                        echo "<a href='projectmortality.php?id=".$rowa['f_id']."' class='btn btn-primary'>View</a>";
                        echo "</td>";
